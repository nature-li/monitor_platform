...
class DbOperator(object):
    server_db_uri = 'mysql+mysqldb://%s:%s@%s:%s/%s' \
                    % (config.mysql_user, config.mysql_pwd, config.mysql_host, config.mysql_port, config.mysql_db)
    engine = create_engine(server_db_uri, echo=False)
